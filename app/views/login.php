...
<head>
    ...
    <title><?= StaticFunctions::lang('Yeniden Hoşgeldin ') . PR_NAME ?></title>
...
<body>
    ...
    -o-background-size: cover;" class="fxt-bg-img fxt-none-767" data-bg-image="/assets/media/login-bg.jpg">
                <div style="margin-top: -40px;" class="fxt-intro">
                    <div class="sub-title"><?= StaticFunctions::lang('Seni yeniden görmek') ?></div>
                ...
                <div class="fxt-header">
                    ...
                    <div class="fxt-page-switcher">
                        <a id="LoginButtonTop" style="min-width: 100px;" href="/login"
                            class="switcher-text switcher-text1 active"><?= StaticFunctions::lang('Giriş') ?></a>
                        <a id="RegisterButtonTop" href="/register"
                            class="switcher-text switcher-text2"><?= StaticFunctions::lang('Kayıt') ?></a>
                    </div>
                </div>
                <div class="fxt-form">
                    <div style="text-align:center;" id="AjaxContent"></div>

                    <form style="margin-top: 10px;" method="POST" action="javascript:;" id="LoginForm">
    ...
    color: #495057;" onkeyup="this.value=this.value.replace(/[^\d]/,'')" maxlength="6" minlength="6"
                    ...
                    <form autocomplete="off" style="display: none;" method="POST" action="javascript:;"
                        id="RegisterForm">
                        <div class="form-group fxt-transformY-50 fxt-transition-delay-1">
                    ...
                    <div class="fxt-footer">
                        <div class="fxt-style-line">
                            <div class="fxt-transformY-50 fxt-transition-delay-5">
                                <hr>
                                <h3 id="H11" style="color:#a4a4a4;font-size:20px;">
                                    <?= StaticFunctions::lang('Veya hızlı giriş yap') ?></h3>
                                <h3 id="H12" style="color:#a4a4a4;font-size:20px;display:none;">
    ...
    <script src="/assets/l/js/login.js?v=<?= Version ?>"></script>
    <script>
    const RecaptchaG = () => {
